<template>
  ...
  <div class="bg-white p-6 sm:p-8 rounded-lg shadow-md w-full max-w-sm sm:max-w-md md:max-w-lg">
    <h1 class="text-lg sm:text-xl md:text-2xl font-bold text-center mb-4 sm:mb-6 text-red-900">Kalkulator Siklus Menstruasi</h1>

      <form @submit.prevent="calculateNextPeriod" class="space-y-4">
        <div class="mb-4">
