      ...
      <form @submit.prevent="calculateNextPeriod" class="space-y-6">
        ...
        <div class="flex flex-col items-start">
          ...
          <div class="flex items-center w-full justify-between">
            <button type="button" @click="updateValue('duration', -1)" class="w-8 h-8 flex items-center justify-center bg-[#f8bbd0] text-white rounded-full hover:bg-[#f4a6c6] transition duration-300">
              -
            </button>
        ...
        <div class="flex flex-col items-start">
          ...
          <div class="flex items-center w-full justify-between">
            <button type="button" @click="updateValue('cycleLength', -1)" class="w-8 h-8 flex items-center justify-center bg-[#f8bbd0] text-white rounded-full hover:bg-[#f4a6c6] transition duration-300">
              -
            </button>
